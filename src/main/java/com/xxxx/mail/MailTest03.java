...
public class MailTest03 {
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        transport.connect("smtp.qq.com","348663490","ddsmvcfzkiavbjhf");
        // 4. 设置Message邮件对象
    ...
    private static Message createAttachMail(Session session) throws MessagingException {
        ...
        // 设置发件人的邮箱地址
        message.setFrom("348663490@qq.com");
        // 设置收件人的邮箱地址
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("348663490@qq.com"));
        // 设置邮件的主题
        ...
        // 本地文件
        DataHandler df = new DataHandler(new FileDataSource("F:\\mailtest\\软件产品报表.docx"));
        // 将本地文件设置到附件对象中
